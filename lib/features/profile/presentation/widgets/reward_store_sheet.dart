...
/// Bottom sheet that contains the old Cube Shop content.
/// Opened from the Profile page's Reward Store section.
void showRewardStoreSheet(BuildContext context) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (ctx) => const _RewardStoreSheet(),
  );
}

class _RewardStoreSheet extends StatefulWidget {
  const _RewardStoreSheet();

  @override
  State<_RewardStoreSheet> createState() => _RewardStoreSheetState();
}

class _RewardStoreSheetState extends State<_RewardStoreSheet> {
      ...
      builder: (context, scrollCtrl) => Container(
        ...
        child: Column(
          children: [
            ...
            const Text('Redeem cubes for exclusive rewards', style: TextStyle(fontSize: 13, color: AppColors.textGrey)),
            const SizedBox(height: 16),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Balance Card
                    _BalanceCard(balance: _cubeBalance),
                    const SizedBox(height: 16),
          ...
          Row(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('Cubes', style: TextStyle(color: Colors.white70, fontSize: 16, fontWeight: FontWeight.w500)),
              ),
            ],
          ),
        ],
...
class _FeaturedCard extends StatelessWidget {
  ...
  final bool isPurchased;
  final VoidCallback onBuy;
  const _FeaturedCard({required this.item, required this.isPurchased, required this.onBuy});
