...
class BookRepository {
  ...
  // Seed list intentionally empty — real books come from the backend now.
  // The legacy mock entries (Midnight Library, Dune, etc.) collided with
  // real backend book IDs and showed wrong reading progress. _books is
  // kept only as a per-bookId progress cache populated lazily by
  // BookDetailsPage / readers via updateProgress() and addPurchasedBook().
